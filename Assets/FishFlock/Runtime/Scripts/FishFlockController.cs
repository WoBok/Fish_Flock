...
namespace FishFlock
{
    ...
    {
        public Vector2 randomSpeed = Vector2.one;
        ...
        void ComputeFlockBehaviours()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < currentFishesCount; i++)
                {
                    ...
                    fish.velocity = Vector3.Lerp((velocity).normalized, (fish.velocity).normalized, ip) * Random.Range(randomSpeed.x, randomSpeed.y);
                ...
                case FlockComputationMode.GPU:
                    {
                        ...
                        computeShader.SetFloat("randomSpeed", Random.Range(randomSpeed.x, randomSpeed.y));
